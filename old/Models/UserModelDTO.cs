...
namespace DiscBotConsole.DataContext
{
    public class UserModelDTO : IDisposable
    {
        ...
        internal async Task AddUser(IUser user)
        {
        ...
        internal async Task<List<UserModel>> GetAllUsers()
        {
        ...
        internal async Task<UserModel> GetUser(ulong userId)
        {
